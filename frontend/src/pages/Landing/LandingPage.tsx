          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem', marginBottom: '1.5rem' }}>
                <a href="FACEBOOK_LINK_HERE" title="Facebook" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', background: 'var(--green-pale)', color: 'var(--dark)', textDecoration: 'none' }}>
                ...
                <a href="INSTAGRAM_LINK_HERE" title="Instagram" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', background: 'var(--green-pale)', color: 'var(--dark)', textDecoration: 'none' }}>
                ...
                <a href="LINKEDIN_LINK_HERE" title="LinkedIn" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', background: 'var(--green-pale)', color: 'var(--dark)', textDecoration: 'none' }}>
